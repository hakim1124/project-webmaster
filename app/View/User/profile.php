                        ...
                        <form method="post" action="/users/profile">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input class="form-control" type="text" id="name" name="name" placeholder="name" value="<?= $model['user']['name'] ?? '' ?>">
                                </div>
                            </div>
                            <button class="btn btn-color submit pull-right" type="submit">Update Profile</button>
                        </form>
                    </div>
                </div>
                <!-- Star -->
